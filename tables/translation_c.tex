...
{\footnotesize
	\begin{longtable}{|l|p{5cm}|p{5cm}|p{5cm}|}
		...
		MF1
		   ...
		   MF3 
           &
             The deep learning applications are critical in many domains. \cellref{D103}, \cellref{D105} \newline
           ...
           & \textbf{Critical in many domains.} This shows how important this technology is. Moreover, DNNs and GPU programming complement each other, where the former is the \textbf{building block} of the latter. However, both technologies pose significant challenges. \\

           \midrule
		   MF4 
           & Data centers are inherently homogenous. BytePS can leverage spare CPU and bandwidth resources to accelerate distributed training running on GPUs. \cellref{D104}
           ...
           \midrule
		   MF6
           & Colossal-AI builds on existing open-source frameworks such as PipeDream, GPipe and Chimera. \cellref{D107}
